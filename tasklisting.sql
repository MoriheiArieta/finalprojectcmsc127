...
--
-- Host: localhost    Database: tasklistingdb
-- ------------------------------------------------------
...
CREATE TABLE `category` (
  ...
  UNIQUE KEY `category_category_name_uk` (`category_name`)
...
CREATE TABLE `task` (
  ...
  `task_completed` varchar(10) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `category_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`task_id`),
  UNIQUE KEY `task_task_name_uk` (`task_name`),
...
-- Dump completed on 2022-05-31  1:09:39
